...
const {
  createNewAlbum, getAlbumByID, readAlbum, removeAlbum, updateAlbum
...
// delete album
router.delete("/album/:albumID/:userID" , requireSignin, isAuth, isAdmin, removeAlbum)
// update album
router.post("/album/:albumID/:userID" , requireSignin, isAuth, isAdmin, updateAlbum)
