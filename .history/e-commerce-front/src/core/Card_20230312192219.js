...
const Card = ({ album, showViewAlbumButton = true }) => {
  ...
  const showArtist = (artist) => {
    return artist ? (
      <span className="badge badge-primary badge-pill">{artist}</span>
    ) : (
      <span className="badge badge-primary badge-pill">No artist</span>
    )
  }
  return (
    <div className="card">
      ...
      <div className="card-body">
        ...
        <br />
        <p className="black-8">Added on {moment(album.createdAt).fromNow()}</p>
