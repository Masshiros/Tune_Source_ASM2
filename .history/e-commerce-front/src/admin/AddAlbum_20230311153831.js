  ...
  const newPostForm = () => (
    <form className="mb-3">
      ...
      <div className="form-group">
        ...
        <input onChange={handleChange('price')} type="numbre" className="form-control" value={price} />
      </div>
      <div className="form-group">
        <label className="text-muted">Genre</label>
        <input onChange={handleChange('genreId')} type="numbre" className="form-control" value={genreId} />
      </div>
    </form>
  );
  return (
